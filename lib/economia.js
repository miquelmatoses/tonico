...
export const UNITATS = {
  ...
  sou_sostenible_setmanal: 'setmana', flux_lliure_setmanal: 'setmana',
...
export async function economia(db, usuariId, hui = null) {
  ...
  return {
    ...
    flux_lliure_setmanal: (() => {
      const fl = fluxLliure(flux, despeses.personal, reserva);
      return fl == null ? null : fl / setmanesPeriode;
    })(),
