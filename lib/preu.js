...
// PREGUNTA("¿venut per quant / deserta?") — es dispara quan `transferible` passa 1→buit
// sense venda apuntada: el jugador ha eixit del mercat i no sabem com. Si va desert, les
// quatre eixides del full: rebaixar · rellistar · despatxar · 1 € (override).
