...
export async function generaAlertes(db, usuariId) {
  ...
  // `hui` entra perquè les caducitats (dades velles, números d'estadi) es mesuren contra la
  // data de la instantània, no contra un rellotge amagat dins de l'avaluador.
  const eco = pla ? await economia(db, usuariId, instSenior.data) : null;
