...
export async function generaAlertes(db, usuariId, hui = new Date().toISOString().slice(0, 10)) {
  ...
  const ctx = { jugadors, juvenils, dataInstantania: instSenior.data, any_dies: anyDies, porter_notable_min: porterNotableMin, mercat, pla: contextPla, personal: contextPersonal, compra: contextCompra, forma_minima: formaMinima, economia: eco, entrenament: entrenamentPrescrit, entrenament_confirmat: entrenamentConfirmat, entrenament_juvenil: entrenamentJuvenil, juvenil_objectiu: juvenilObjectiu, cobertura: contextCobertura, revelacions: revelacionsJuv, crida, dies_subhasta: diesSubhasta, setmana_inici_data: setmanaIniciData, vendes_llistades: vendesLlistades };
