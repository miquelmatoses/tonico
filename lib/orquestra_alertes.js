...
export async function generaAlertes(db, usuariId) {
  ...
  const ctx = { jugadors, juvenils, dataInstantania: instSenior.data, any_dies: anyDies, mercat, pla: contextPla, pendents_transaccio: pendents, personal: contextPersonal };
