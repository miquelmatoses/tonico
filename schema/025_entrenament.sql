...
-- util_min: potencial de l'habilitat principal per a ser ÚTIL (proveïdor de rotatius) en
...
UPDATE fases_config SET config = json_set(config, '$.entrenament',
  json('{"tipus":"creativitat","intensitat":100,"resistencia":10,"principal":"creativitat","secundari":"passades","vendibles":["anotacio","extrem","defensa"],"util_min":5,"sostre_min":2,"vendible_min":5,"parells_permesos":["defensa","anotacio","creativitat"]}'))
 WHERE plantilla = 'competitiva';
