...
INSERT INTO plantilles_parametres (plantilla, clau, valor, tipus) VALUES
  ('fabrica', 'valor_estimat_defecte', '150000', 'int'),   -- venda sense comparable (estimació grossa)
  ('fabrica', 'valor_fornada_estimat', '300000', 'int');   -- valor per fornada que ix (recalibrable)
