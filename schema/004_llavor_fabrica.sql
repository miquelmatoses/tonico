...
INSERT INTO plantilles_parametres (plantilla, clau, valor, tipus) VALUES
  ('competitiva', 'llindar_intercanvi',   '1.0',                                        'float'),
  ('competitiva', 'valor_especialitats',  '["Potent","Ràpid","Joc aeri","Tècnic","Imprevisible"]', 'json'),
  ('competitiva', 'buckets_posicio',      '{"mc":["MC"],"extrem":["ED","EE"]}',         'json'),
  ('competitiva', 'categoria_terminal',   'alliberament',                               'text'),
  ('competitiva', 'fornada_finestra_dies','21',                                         'int'),
  ('competitiva', 'edat_pic_venda',       '20',                                         'int');
...
INSERT INTO plantilles_categories (plantilla, categoria, es_funcio, aforament, ordre, parametres) VALUES
  ('competitiva', 'entrenable', 1, NULL, 1,
  ...
  ('competitiva', 'farciment', 1, NULL, 4,
