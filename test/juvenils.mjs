// Tonico — Juvenils (Fase 7): projecció d'aterratge, crides i alerta predictiva.
// node test/juvenils.mjs
...
const resp = await apiJuvenils.onRequestGet({ env: { DB: db }, data: { usuari: { id: 1 } } });
